...
public class SearchController {
    ...
    public SearchResponse searchByImage(
        ...
        return searchService.searchByImage(image, description, topK, targetType);
    }
    ...
    public SearchResponse searchByText(@org.springframework.web.bind.annotation.RequestBody
                                       SearchByTextRequest request) {
        return searchService.searchByText(
            request.text(),
            request.topK(),
            request.targetType()
        );
